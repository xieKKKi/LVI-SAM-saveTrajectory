...
public:
    ...
    ParamServer()
    {
        ...
        nh.param<std::string>(PROJECT_NAME + "/savePCDDirectory", savePCDDirectory, "/tmp/LVI_SAM_PCD/");
        nh.param<bool>(PROJECT_NAME + "/saveTXT", saveTXT, false);
        nh.param<std::string>(PROJECT_NAME + "/saveTXTDirectory", saveTXTDirectory, "/tmp/LVI_SAM_TXT/");
