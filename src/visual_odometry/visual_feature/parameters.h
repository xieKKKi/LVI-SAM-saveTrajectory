...
extern int saveCameraTimestamp;
extern string saveCameraTimestampDirectory;

extern int saveFeaturePointsAndDepth;
extern string saveFeaturePointsAndDepthDirectory;
